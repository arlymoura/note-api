...
class StickersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sticker" do
    assert_difference('Sticker.count') do
      post stickers_url, params: { sticker: { body: @sticker.body, count: @sticker.count, name: @sticker.name } }, as: :json
    end
  ...
  test "should update sticker" do
    patch sticker_url(@sticker), params: { sticker: { body: @sticker.body, count: @sticker.count, name: @sticker.name } }, as: :json
    assert_response 200
  end
